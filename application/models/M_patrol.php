...
class M_patrol extends CI_Model
{
	...
	{
		$query = $this->db->query("SELECT  u.name, u.npk, u.email, u.patrol_group, u.admisecsgp_mstroleusr_role_id , r.level , c.comp_name , s.site_name , p.plant_name  , u.status , u.admisecsgp_mstsite_site_id as site_id
	...
	{
		$query = $this->db->query("SELECT  u.name , u.npk, u.email ,u.patrol_group, u.admisecsgp_mstroleusr_role_id , r.level , c.comp_name , s.site_name , p.plant_name  , u.status , u.admisecsgp_mstplant_plant_id , u.admisecsgp_mstsite_site_id 
        FROM admisecsgp_mstusr u , admisecsgp_mstroleusr r , admisecsgp_mstcmp c , admisecsgp_mstsite s
        , admisecsgp_mstplant p

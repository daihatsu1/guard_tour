...
class Mst_Jadwal extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['lihat'])) {
            ...
            $data['jadwal']       = $this->M_patrol->showJadwal($tahun, $bulan, $plant_id);
        }
        ...
        $this->load->view("mst_jadwal", $data);
        $this->load->view("template/footer");
    }

    public function form_upload_jadwal()
    {
    }
    ...
    public function form_rubah_jadwal_petugas(Type $var = null)
    {
        ...
        if (isset($_POST['lihat'])) {
            ...
            $data['petugas'] = $this->M_patrol->petugasPerTanggal($col_tanggal, $bulan, $tahun, $plant_id);
            //data pencarian
    ...
    public function update_petugas_patroli(Type $var = null)
    {
        ...
        $update = $this->M_patrol->update("admisecsgp_mstjadwalpatroli", $data, ['id' => $id]);
        if ($update) {

...
class Mst_Checkpoint extends CI_Controller
{
    ...
    public function form_add()
    {
        ...
        $data = [
            'link'       => $this->uri->segment(2),
            "plant"      => $this->M_admin->ambilData("admisecsgp_mstplant", ['admisecsgp_mstsite_id' => $id_wil_user, 'status' => 1])
        ];
    ...
    public function multipleDelete()
    {
        ...
        $delete = $this->M_admin->multiple_delete("admisecsgp_mstckp", $id_event);
    ...
    public function edit()
    {
        ...
        $data = [
            ...
            "plant"      => $this->M_admin->ambilData("admisecsgp_mstplant", ['admisecsgp_mstsite_id' => $id_wil_user]),
        ];

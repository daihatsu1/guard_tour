...
class Mst_Jadwal_Produksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (isset($_POST['lihat'])) {
            ...
            $data['jadwal']       = $this->M_patrol->showProduksi($tahun, $bulan, $plant_id);
        }
    ...
    public function form_rubah_jadwal_produksi(Type $var = null)
    {
        ...
        if (isset($_POST['lihat'])) {
            ...
            //load data produksi
            $data['produksi'] = $this->M_patrol->produksiPerTanggal($colom_stat_zona, $tahun, $bulan,  $col_tanggal, $plant_id, $colom_select_tgl);
    ...
    public function load_data_produksi(Type $var = null)
    {
        ...
        $data =  [
            ...
            'data_zona'                  => $this->M_patrol->ambilData("admisecsgp_mstzone", ['admisecsgp_mstplant_id'    => $plant_id]),
    ...
    public function update_jadwal_produksi(Type $var = null)
    {
        ...
        $update = $this->M_patrol->update("admisecsgp_mstproductiondtls", $data, ['id' => $id]);
        if ($update) {
            echo "1";
        } else {
    ...
    public function revisi_upload_jadwal(Type $var = null)
    {
        ...
        $update_production = $this->M_patrol->update(
        ...
        if ($update_production) {
            $this->M_patrol->mulitple_upload("admisecsgp_mstproductiondtls", $data_prod);
            $this->session->set_flashdata('info', '<i class="icon fas fa-check"></i> Berhasil upload data');
            redirect('Mst_Jadwal_Produksi');
        } else {

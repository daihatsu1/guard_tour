        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Upload_Jadwal') ?>">Jadwal</a></li>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('Upload_Jadwal') ?>" onsubmit="return cekExe()" enctype="multipart/form-data">
                        ...
                        <hr>
                        <form action="<?= base_url('Mst_Jadwal/upload') ?>" method="post" enctype="multipart/form-data" class="mt-2">
                            <?php
                            ...
                            if (isset($_POST['view'])) {
                                ...
                                if ($cekplant->num_rows() <= 0) {
                                    ...
                                    $plt = $cekplant->row();
                                    $cekjadwalexist = $this->db->get_where('admisecsgp_mstjadwalpatroli', ['admisecsgp_mstplant_id' => $plt->id, 'bulan' => $bulan_patroli, 'tahun' => $tahun_patroli]);
                                    if ($cekjadwalexist->num_rows() > 1) {
                                        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        Jadwal Patroli <b class="font-italice">' . $bulan_patroli . ' ' . $tahun_patroli . '</b> sudah terupload , gunakan menu koreksi jadwal untuk melakukan perubahan jadwal patroli
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>';
                                    ...
                                    if ($cekjadwalProduksiexist->num_rows() > 1) {
                                        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        Jadwal Produksi <b class="font-italice">' . $bulan_patroli . ' ' . $tahun_patroli . '</b> sudah terupload , gunakan menu koreksi jadwal untuk melakukan perubahan jadwal produksi
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>';
                                    ...
                                    foreach ($jadwal as $jdl) {
                                        //cek data npk user 
                                        $cek_user = $this->db->get_where("admisecsgp_mstusr", ['npk' => $jdl[2], 'name' => $jdl[3]]);
                                        //jika tidak maka muncul alert 

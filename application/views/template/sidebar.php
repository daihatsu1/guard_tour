...
<div class="wrapper">
	...
	<aside class="main-sidebar sidebar-dark-info elevation-4">
		...
		<a href="<?= base_url('assets') ?>/index3.html" class="brand-link">
			<img src="<?= base_url('assets') ?>/dist/img/logo.jpeg" alt="AdminLTE Logo" style='margin-left:2px'
				 class="brand-image img-square elevation-5" style="opacity: .8">
		...
		<div class="sidebar">
			...
			<div class="user-panel mt-3 pb-3 mb-3 d-flex">
				<div class="image">
					<img src="<?= base_url('assets') ?>/dist/img/security.png" class="img-circle elevation-2"
						 alt="User Image">
				</div>
				<div class="info">
		   ...
		   with font-awesome or any other icon font library -->
					...
					<li class="nav-item <?php if (($link == 'Laporan_Temuan') || ($link == 'Laporan_Patroli')) {
						...
						<ul class="nav nav-treeview">
							<li class="nav-item">
								<a href="<?= base_url('Laporan_Patroli') ?>"
							...
							<li class="nav-item">
								<a href="<?= base_url('Laporan_Temuan') ?>"

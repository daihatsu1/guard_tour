        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form action="<?= base_url('Mst_Jadwal/form_rubah_jadwal_petugas') ?>" method="post" id="updateJadwal">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                            ...
                            <a href="<?= base_url('Mst_Jadwal') ?>" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<script>
    function showuserdetail(idUpdate, idPlant, idUser, kolomUpdate, dataShift, datePatrol) {
        $.ajax({
            type: "post",
            url: "<?= base_url('Mst_Jadwal/load_data_petugas'); ?>",

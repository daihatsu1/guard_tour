		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item"><a href="<?= base_url('Admin/Laporan_Patroli') ?>">Laporan Temuan</a></li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
			...
			columns: [
				...
				},
				{
					...
					render: function (data, type, row) {
						...
						const actionURL = "<?=base_url('Admin/Laporan_Temuan/update_status_temuan') ?>";
						let img = '<a href="<?=base_url()?>' + row.image_1 + '"  data-lightbox="' + row.object_id + '" data-title="' + row.nama_objek + '">';

						if (row.image_1 !== null) {
							img = img + '<img src="<?=base_url()?>' + row.image_1 + '" class="img-thumbnail" data-lightbox="' + row.object_id + '" data-title="' + row.nama_objek + '" width="50px" alt="' + row.nama_objek + '">';
						}
						if (row.image_2 !== null) {
							img = img + '<img src="<?=base_url()?>' + row.image_2 + '" class="img-thumbnail" data-lightbox="' + row.object_id + '" data-title="' + row.nama_objek + '" width="50px" alt="' + row.nama_objek + '">';

						}
						if (row.image_3 !== null) {
							img = img + '<img src="<?=base_url()?>' + row.image_3 + '" class="img-thumbnail" data-lightbox="' + row.object_id + '" data-title="' + row.nama_objek + '" width="50px" alt="' + row.nama_objek + '">';
						}
						img = img + '</a>';
						return `

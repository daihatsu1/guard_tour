        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="<?= base_url('Admin/Mst_Event_Detail/form_upload_event_detail') ?>">Upload Event Detail</a></li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('Admin/Mst_Event_Detail/form_upload_event_detail') ?>" onsubmit="return cekExe()" enctype="multipart/form-data">
                            ...
                            <div class="form-inline mt-2">
                                <a href="<?= base_url('Admin/Mst_Event_Detail') ?>" class="mr-2 btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>

                                <input type="submit" value="Upload Event Detail" name="view" class="btn btn-info btn-sm"></input>
                            </div>
                        </form>
                        <hr>
                        <form action="<?= base_url('Admin/Mst_Event_Detail/upload_event') ?>" method="post" enctype="multipart/form-data" class="mt-2">
                            <?php
                            ...
                            if (isset($_POST['view'])) {
                                ...
                                if ($count <= 0) {
                                    redirect('Admin/Mst_Event_Detail/upload_event');
                                }
                            } ?>

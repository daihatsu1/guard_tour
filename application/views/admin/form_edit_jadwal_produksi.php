        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="<?= base_url('Admin/Mst_Jadwal_Produksi') ?>">Master</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form action="<?= base_url('Admin/Mst_Jadwal_Produksi/form_rubah_jadwal_produksi') ?>" method="post" id="updateJadwal">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-3">
                            ...
                            <a href="<?= base_url('Admin/Mst_Jadwal_Produksi') ?>" class="btn btn-success btn-sm"><i class="fas fa-arrow-left"></i> Kembali</a>
...
<script>
    function showuserdetail(idUpdate, idPlant, idZona, idShift, idProduksi, colomStatusZona, colomProduksi, statusZona, dateProduksi) {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url('Admin/Mst_Jadwal_Produksi/load_data_produksi'); ?>",
    ...
    $("select[name=plant_id3").on('change', function() {
        ...
        if (id == null || id == "") {
            ...
            $.ajax({
                url: "<?= base_url('Admin/Mst_Jadwal_Produksi/showZone') ?>",
                method: "POST",
                data: "id=" + id,
                beforeSend: function() {
    ...
    $("#submitDataTambah").on('submit', function(e) {
        ...
        if (id == "" || id == null) {
            ...
            $.ajax({
                url: "<?= base_url('Admin/Mst_Jadwal_Produksi/input') ?>",
                method: 'POST',

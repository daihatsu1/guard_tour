    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card mt-2">
                    <div class="card-body">
                        <form method="post" action="<?= base_url('Admin/Mst_objek/form_upload') ?>" onsubmit="return cekExe()" enctype="multipart/form-data">
                        ...
                        <form action="<?= base_url('Admin/Mst_objek/upload') ?>" method="post" enctype="multipart/form-data" class="mt-2">
                            <?php
                            $count = 0;
                            if (isset($_POST['view'])) {
                                foreach ($sheet as $sh) {
                                ...
                                if ($count <= 0) {
                                    redirect('Admin/Mst_objek/upload');
                                }
                            }
                            ?>
                        </form>

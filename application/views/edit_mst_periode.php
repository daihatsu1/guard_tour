        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <form onsubmit="return cek()" action="<?= base_url('Mst_Periode/update') ?>" method="post" id="inputEvent">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="shift" id="shift">
                                    <option value="<?= $data->admisecsgp_mstshift_id ?>">SHIFT <?= $data->nama_shift ?></option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" value="<?= $data->total ?>" name="total" id="total">
                            </div>

<style xmlns="http://www.w3.org/1999/html">
	...
	.year-picker .ui-datepicker-month {
		display: none;
	}
</style>
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="d-flex justify-content-center mb-2 month-picker"
							 data-chart="chartTemuanByKategori" data-filterplant="true"
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="d-flex justify-content-center mb-2 month-picker"
							 data-chart="chartTrenTemuan" data-filterplant="true"
			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="d-flex justify-content-center mb-2 month-picker"
							 data-chart="chartTrenPatroli" data-filterplant="true"
...
<script>
	...
	function ajaxTemuanPlant(params) {
		$.ajax({
	...
	function ajaxPatroliPlant(params) {
		$.ajax({
